// Vendored from https://github.com/mnemnion/mvzr — v0.3.9 (src/mvzr.zig), MIT License.
// Copied verbatim; do not edit here (wrap in ../regex.zig instead). Its own tests run under
// `zig build test` through ../main.zig; 31/31 passed on Zig 0.16.0 when vendored (2026-08-18).
